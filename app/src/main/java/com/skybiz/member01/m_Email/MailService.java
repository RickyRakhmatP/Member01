...
public class MailService {
    ...
    final private static String SMTP_SERVER = DataService.SETTING_SMTP_SERVER;
    private String from;
    ...
    private static class SMTPAuthenticator extends javax.mail.Authenticator {
        ...
        protected PasswordAuthentication getPasswordAuthentication() {
            ...
            String username = DataService.SETTING_SMTP_USER;
            String password = DataService.SETTING_SMTP_PASSWORD;
